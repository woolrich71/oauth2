package se.woolrich.oauth2.security;
...
import se.woolrich.oauth2.services.TokenBlackListService;
...
public class AuthorizationConfig extends AuthorizationServerConfigurerAdapter {
    ...
    public void configure(ClientDetailsServiceConfigurer  clients) throws Exception {
        clients
                .inMemory()
                .withClient(clientId.trusted_app.toString())
                    ...
                    .scopes(scopes.read.toString(), scopes.write.toString())
                    .resourceIds(resourceId)
                    .accessTokenValiditySeconds(10)
                    .refreshTokenValiditySeconds(60)
                    .secret("secret")
                .and()
                .withClient(clientId.register_app.toString())
                    .authorizedGrantTypes(authorizedGrantTypes.client_credentials.toString())
                    .authorities(Role.ROLE_REGISTER.toString())
                    .scopes(scopes.registerUser.toString())
                    .accessTokenValiditySeconds(10)
